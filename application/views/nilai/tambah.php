...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Input Nilai Akhir</h1>
    ...
    <div class="col-lg-8 col-md-10 col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Formulir Input Nilai Mahasiswa</h6>
            </div>
            <div class="card-body">
                <?php echo form_open('nilai/tambah'); ?>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="matakuliah_id" name="matakuliah_id" required>
                        ...
                        <?php foreach ($matakuliah as $mk): ?>
                            <option value="<?php echo $mk['id']; ?>" data-semester="<?php echo (int) $mk['semester']; ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="nilai_angka" name="nilai_angka" min="0" max="100" step="0.01" placeholder="Contoh: 82.5" required>
                    <small class="form-text text-muted">
                        Nilai huruf otomatis dikalkulasikan saat data disimpan:<br>
                        &ge; 90 = <strong>A</strong> | &ge; 80 = <strong>B</strong> | &ge; 70 = <strong>C</strong> | &ge; 60 = <strong>D</strong> | &lt; 60 = <strong>E</strong>
                    </small>
                </div>
